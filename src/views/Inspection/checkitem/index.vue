<template>
  <div class="home">
    ...
    <el-dialog
      :visible.sync="editInsVisible"
      :before-close="$closeVis('editInsVisible')"
      :center="true"
...
<script>
  ...
  import editIns from '@/views/inspection/checkitem/components/editIns'
  ...
  export default {
    ...
    data() {
      return {
        ...
        activeName:'a',
        activeType:'aa',
        importFileOper:Const.importFile.inspectionItem,
