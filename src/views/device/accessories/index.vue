<template>
  <div class="home">
      ...
      <div class="scroll-left">
        ...
        >
          <span class="custom-tree-node" slot-scope="{ node, data }">
            ...
            <i class="el-icon-share eq__icon" @click="showDialog"></i>
          </span>
        </el-tree>
      </div>
    ...
    <el-dialog
      ...
      width="1200px"
    >
      <detailAcc v-if="accDetailVisible" :data="data" @close="handleClose" />
    </el-dialog>
    <el-dialog
...
import { getByCateName, getOrgTree} from '@/api/data';
import DistriDialog from './components/DistriDialog.vue';
...
export default {
    ...
    return {
      ...
      list: [
        ...
        },
        {
          name: "我是测试",
          photo:
            "https://resource.ycyh56.com/images/photo/17103423388288.png?1604744647633",
          id: 2,
        },
      ],
      defaultProps: {
  ...
  methods: {
    showDialog() {
      this.cpUserVisible = !this.cpUserVisible;
    },
    getValue(data){
