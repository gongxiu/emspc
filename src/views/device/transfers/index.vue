<template>
  <div  class="body-pd">
    <el-tabs v-model="transfersType" type="border-card">
      <el-tab-pane label="我的调拨" name="a">
        <div>
          <div class="body-title">
            <div class="ch-title-left">
              <el-select v-model="approvalType" size="mini" placeholder="选择设备类型" filterable>
                <el-option
...
<script>
  ...
  import editTran from "@/views/device/transfers/components/edittran"
  import detailTran from "@/views/device/transfers/components/detailtran"
  export default {
    name: "index",
    components:{
      editTran,
